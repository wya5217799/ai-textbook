// AI Concept Classifier Quiz MicroSim
// Students classify AI/ML concepts into their correct taxonomy category
// Based on the H63AIS Artificial Intelligence System course
...
let config = {
  ...
  instructionText: 'Select the correct category for this concept',
...
function setup() {
  ...
  let title = quizData?.title || 'AI Concept Classifier Quiz';
  describe(title + ' - an interactive classification quiz for AI and ML concepts', LABEL);
}
...
// Mascot character - Neural network brain with circuit patterns
...
function drawEndScreen() {
  ...
  if (perfMessages) {
    ...
    if (scorePercent >= 90) {
      message = 'Outstanding!';
      subMessage = 'You have excellent AI concept classification skills.';
    } else if (scorePercent >= 70) {
      message = 'Great Job!';
      subMessage = 'You classified most AI concepts correctly.';
    } else if (scorePercent >= 50) {
      message = 'Good Progress!';
      subMessage = 'Keep studying to improve your understanding.';
    } else {
      message = 'Keep Learning!';
      subMessage = 'Review the course taxonomy and try again.';
    }
  }
